...
public class AddCourseTeacher {
		...
		// Teacher add the new course
		@Test
		public void addCourse() {

//			driver.findElement(By.className("coursename")).sendKeys("Spring");
//			driver.findElement(By.className("instructorname")).sendKeys("Anitha");
//			driver.findElement(By.className("youtubeurl")).sendKeys("www.youtube.com/Spring");
...
//			driver.findElement(By.className("description")).sendKeys("Learn about the Spring");
